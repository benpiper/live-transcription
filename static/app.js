...
let watchwords = [];
// Performance Optimization: Cache pre-compiled RegExes and lowercase string variants
// to prevent repetitive memory allocations during high-frequency UI render loops (e.g., checkWatchwords)
let watchwordsLower = [];
