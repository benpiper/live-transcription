...
if (notificationBtn) {
    notificationBtn.addEventListener('click', async () => {
        ...
        if (Notification.permission === 'denied') {
            ...
            const detail = `How to fix: 1. Click the 'Locks/Settings' icon next to the URL in the address bar. 2. Change the 'Notifications' setting to 'Allow'. 3. Refresh this page.`;
            showSystemAlert('error', msg, detail);
            return;
        }
